...
const IncidentesCard = ({ onClick }: IncidentesCardProps) => {
  const handleClick = () => {
    onClick('FISCALIZAÇÃO', 'Sanções e compliance');
    window.dispatchEvent(new CustomEvent('showFiscalizacao'));
  };
    ...
    <div className="relative group">
      ...
      >
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-white text-xs">Relatórios executivos</p>
        </div>
