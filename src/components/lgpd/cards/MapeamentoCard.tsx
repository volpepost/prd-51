    ...
    <div className="relative group">
      ...
      >
        ...
        <div className="text-center space-y-3">
          <Database className="w-8 h-8 text-pastel-blue-dark mx-auto group-hover:scale-110 transition-transform" />
          <h3 className="font-bold text-pastel-blue-dark text-sm">MAPEAMENTO</h3>
