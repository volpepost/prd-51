...
import { X, Map, AlertCircle, CheckCircle, Shield, Eye, Clock, Users } from 'lucide-react';
        ...
        <div className="relative z-10">
          ...
          <div className="backdrop-blur-md bg-gradient-to-r from-pastel-blue-light/20 via-pastel-blue-medium/20 to-pastel-gray-medium/20 border-b border-white/30 p-6 -m-4 sm:-m-6 lg:-m-8 mb-6 lg:mb-8 rounded-t-2xl">
            <div className="flex items-center space-x-3">
              <Map className="w-10 h-10 text-pastel-blue-dark" />
              <div>
                <h2 className="text-xl font-bold text-gray-900">Mapeamento de Dados Pessoais</h2>
                <p className="text-sm text-gray-700">O que você DEVE LEMBRAR TODOS OS DIAS para aplicar o Mapeamento de Dados</p>
              </div>
            </div>
          </div>
